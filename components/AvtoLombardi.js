...
import AvtoLombardiData from '../public/data/lomb-loans.json';
import styles from "../styles/ContentTable.module.css"

function AvtoLombardiTable() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await Promise.resolve(AvtoLombardiData);
        setData(data);
      } catch (error) {
...
export default AvtoLombardiTable;
